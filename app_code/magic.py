...
def main():
    ...
    if len(sys.argv) != 28:
        print("Usage: needs more or less args 29 is needed, recieved", len(sys.argv))
        sys.exit(1)
    ...
    places_for_special1 = ['157,187', '178,187', '155,190', '177,190', '177,190']

    index_places_special1 = 0
    if template == "./sorcerer.png":
        index_places_special1 = 0
    elif template == "./paladin.png":
        index_places_special1 = 1
    elif template == "./druid.png":
        index_places_special1 = 2
    elif template == "./cleric.png":
        index_places_special1 = 3
    elif template == "./bard.png":
        index_places_special1 = 4
    ...
    replacements['77,220'] = float(health_precent)
    if max_mp != -1:
        #print(max_mp)
        #print("yo!")
        replacements['78,248'] = float(mana_precent)
